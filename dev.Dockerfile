...
RUN apk --no-cache add \
    ...
    php7-sockets php7-tokenizer php7-xml php7-xmlreader php7-xmlwriter php7-zip php7-zlib php7-pdo_sqlite
...
RUN composer self-update 1.10.16\
    && composer create-project --prefer-dist --stability dev engage-php/luminary:dev-develop . \
    && composer clearcache \
    && rm -rf composer.lock
